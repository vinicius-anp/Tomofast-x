...
module magnetic_field
  ...
  type, public :: t_magnetic_field
    ...
    double precision, dimension(3) :: magv2
...
subroutine magnetic_field_initialize(this, mi, md, theta, intensity)
  ...
  call this%dircos(mi, md, theta, ma, mb, mc, .true.)

  this%magv(1) = ma
  this%magv(2) = mb
  this%magv(3) = mc

  call this%dircos(mi, md, theta, ma, mb, mc, .false.)
...
!==============================================================================
subroutine dircos(incl, decl, azim, a, b, c, project)
    ...
    call this%sharmbox(real(Xdata, SENSIT_REAL), &
      ...
      ! Susceptibility model.
        ...
        if (ndata_components == 1) then
          sensit_line(i, 1, 1) = mx * this%magv2(1) + my * this%magv2(2) + mz * this%magv2(3)
...
subroutine mbox2(x, y, z, x1, y1, z1, x2, y2, z2, ts_x, ts_y, ts_z)
  ...
  ts_z(3) = ( &
                (-2.d0 * atan2(dz2, arg1_ + tol1)) &
                - (-2.d0 * atan2(dz2, arg6_ + tol1)) &
                + (-2.d0 * atan2(dz1, arg11_ + tol1)) &
                - (-2.d0 * atan2(dz1, arg16_ + tol1)) &
                + (-2.d0 * atan2(dz2, arg21_ + tol1)) &
                - (-2.d0 * atan2(dz2, arg26_ + tol1)) &
                + (-2.d0 * atan2(dz1, arg31_ + tol1)) &
                - (-2.d0 * atan2(dz1, arg36_ + tol1)) &
            )
  ...
  if (l_inside) then
    print *, "OLOLO:", ts_x(1) + ts_y(2) + ts_z(3)
  endif
